...
// ====================================================================
// 图像捕获和编码函数的声明 (外部定义)
// 在你的Mod的某个.cpp文件中实现这些函数
// ====================================================================
std::vector<unsigned char> GetSimulatedRGBImageBytes();
std::vector<unsigned char> GetSimulatedDepthImageBytes();
...
private:
    ...
    // 获取文件字节数据的函数
    std::vector<unsigned char> GetBytes(std::wstring filePath);
