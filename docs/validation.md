...
Recorded terminal observations whose proposed action was not executed use
`action_execution=NOT_EXECUTED` and retain the explicit failure reason. This
includes shadow-mode `NO_EXPERT_LABEL`, horizon exhaustion, and executor errors.
